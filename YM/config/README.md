...
4. `MONGO_DB_URI` : Get mongo db [from here.](ee)
...
- You can generate telegaph links from [](ee) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@](ee) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@](ee) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@(ee) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@](ee) in Telegram.
